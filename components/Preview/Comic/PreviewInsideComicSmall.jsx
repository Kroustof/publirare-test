...
const PreviewInsideComicSmall = ({ isFullWidth = false, canvasBg, backgroundImg = bgExample, insideCover, pagesColor, content }) => {
  return (
    <div className="relative w-full max-w-[500px] h-[500px] flex justify-center items-center overflow-hidden" style={{ "backgroundColor": `${canvasBg}` }}>
      ...
      <div className={`${
          isFullWidth 
            ...
            : "relative py-[7px] pr-[20px] pl-[3px] w-[304px] h-[444px] overflow-hidden"
          } 
...
export default PreviewInsideComicSmall
