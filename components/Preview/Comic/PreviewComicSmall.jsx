import styles from './previewComicSmall.module.css'
...
const previewComicSmall = ({ canvasBg, backgroundImg = bgExample, coverImg = coverExample, insideBack }) => {
  return (
...
export default previewComicSmall
