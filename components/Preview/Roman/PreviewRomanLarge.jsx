import styles from './previewRomanLarge.module.css'
...
const previewRomanLarge = ({ canvasBg, backgroundImg = bgExample, coverImg = coverExample, insideBack }) => {
  return (
...
export default previewRomanLarge
