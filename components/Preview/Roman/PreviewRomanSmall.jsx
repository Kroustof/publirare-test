import styles from './previewRomanSmall.module.css'
...
const previewRomanSmall = ({ canvasBg, backgroundImg = bgExample, coverImg = coverExample, insideBack }) => {
  return (
...
export default previewRomanSmall
