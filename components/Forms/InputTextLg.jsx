...
const InputTextLg = ({ name, id, placeholder, inputRef, required, details }) => {
  return (
    <span className="relative">
      ...
      <input 
        ...
        className="form-input mt-2 px-5 py-2.5 w-full block shadow-sm rounded-full border-gray-200 bg-gray-100 text-base placeholder-gray-400 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:bg-white"
      />
    </span>
  )
}
